...
//
// Code to emprically derive the drive distance of a robot per motor tick.  
// Step 1) Select Motor Type Ln 84, Confirm STEP in Ln 83 = 1
// Step 2) Mark Robot Start positon from back wheels with tape
// Step 3) Run the code once - measure resulting distance.
//         This will give an approximate drive distance per signle rotation
// Step 4) Update the infomation in the switch-case starting on Ln 100 for the DistPerRot
// Step 5) Update Ln 83, STEP = 5, This will have the robot drive for ~1m.
// Step 6) Mark the start of the robot, run the code and measure the resulting distance. It should be close to 1m.
// Step 7) Update the DistPerRot based on new measurement.  Rinse and repeat, until exact.
// Step 8) Reset Ln 83, STEP = 1
//
