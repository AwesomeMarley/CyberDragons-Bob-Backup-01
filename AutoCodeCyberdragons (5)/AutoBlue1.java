...
// Current Version: 2021-14-12 - Kai Rodriguez, Luca Cipresso, & Teddy Telanoff
//
...
public class AutoBlue1 extends LinearOpMode { //Locate Special Object
    ...
    public void runOpMode() {
        ...
        switch (ARMMOTOR) {
            ...
            case "REV20":
                ArmTicksPerRot = 560;
                ArmLevelTicks = new int[]{0, 1000, 900, 750, 200}; // ArmLevelTicks[0] = ticks for down, ArmLevelTicks[1] = ticks for level 1, ...
                break;
            case "REV40":
        ...
        crab(-240,0.25);
        RunArm(ArmLevelTicks[4], ArmUpSpeed);
        
        
        TOFcm = TOF_Left.getDistance(DistanceUnit.CM);
        ...
        drive(ToTheSide, 0.25); // cm to the right, speed = 25%
    ...
    private void DoStuffWhileMoving() {
        ...
        TOFcm = TOF_Left.getDistance(DistanceUnit.CM);
        switch (Step) {
            case 0: // Drive towards bird bath and figure out where the bar code object
            ...
            case 1: 
                ...
                break;
            case 2:// Drive towards Bird Bath and Move Arm to Correct Level
                // *******************************
